...
function checkSettings(settingsFromClient) {
  ...
  if (!(typeof settingsFromClient.audio.attenuation === 'number' && settingsFromClient.audio.attenuation >= 0.0001)) throw new Error('AMI settings file validation error: audio.attenuation invalid or missing')
