...
- TODO: SOUND-1 compressorNode (троттлинг-лимит не нужен, громкость ограничится сама)
- TODO: SOUND-2 EQ не нужен, он не меняет сильно звук, оставляем lowpass, но добавляем Q-параметр, гейн у него убираем (он не юзается).
- TODO: SOUND-3 LFO - осциллятор управляет осциллятором (может управлять у гейна гейном, у осциллятора частотой)
- TODO: UI-1 сделать контроль перехода на противоположную полусферу
- TODO: UI-2 режим левши/правши (если поменять местами от/до не неполучится искомое?)
