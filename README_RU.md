...
### Простое использование (запуск веб-версии на ami.stranno.su)
<a id="simple"></a>
...
### Рекомендуемое использование (запуск на локальном компьютере)
<a id="recommended"></a>
...
### Продвинутое использование (запуск на локальном компьютере + обработка звука)
<a id="pro"></a>
...
### Хранение состояния (настроек) системы
